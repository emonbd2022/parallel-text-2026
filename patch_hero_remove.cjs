...
const oldHero = `<div className="flex flex-col items-center gap-4">
...
const newHero = `<svg width="56" height="56" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="drop-shadow-[0_0_15px_rgba(59,130,246,0.5)]">
                           <path d="M12 13v8"/>
